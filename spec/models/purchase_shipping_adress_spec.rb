  ...
  describe '商品購入機能の実装' do
    context '商品購入機能の実装の正常系' do
      ...
      it '建物名は任意であること。' do
        @purchase_shipping_adress.user_id = @user.id
        @purchase_shipping_adress.item_id = @item.id
        @purchase_shipping_adress.building_name = ''
        expect(@purchase_shipping_adress).to be_valid
      end
    end
    ...
    context '商品購入機能の実装の異常系' do
      it 'user_idがないと、商品の購入ができないこと。' do
        ...
        expect(@purchase_shipping_adress.errors.full_messages).to include("Userを入力してください")
      end
      it 'item_idがないと、商品の購入ができないこと。' do
        @purchase_shipping_adress.user_id = @user.id
        @purchase_shipping_adress.item_id = ''
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include("Itemを入力してください")
      end
      it 'tokenがないと、商品の購入ができないこと。' do
        ...
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include("トークンを入力してください")
      end
      it '郵便番号が必須であること。' do
        @purchase_shipping_adress.user_id = @user.id
        @purchase_shipping_adress.item_id = @item.id
        ...
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include("郵便番号を入力してください")
      end
      it '郵便番号は、「3桁ハイフン4桁」の半角文字列のみ保存可能なこと（良い例：123-4567 良くない例：1234567）。' do
        ...
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include('郵便番号は不正な値です')
      end
      ...
      it '都道府県が必須であること。' do
        ...
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include('都道府県を入力してください')
      end
      it '都道府県のIDが1以外が必須であること。' do
        @purchase_shipping_adress.user_id = @user.id
        @purchase_shipping_adress.item_id = @item.id
        @purchase_shipping_adress.prefecture_id = 1
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include('都道府県は1以外の値にしてください')
      end
      it '市区町村が必須であること。' do
        @purchase_shipping_adress.user_id = @user.id
        @purchase_shipping_adress.item_id = @item.id
        ...
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include("市区町村を入力してください")
      end
      it '番地が必須であること。' do
        @purchase_shipping_adress.user_id = @user.id
        @purchase_shipping_adress.item_id = @item.id
        ...
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include("番地を入力してください")
      end
      it '電話番号が必須であること。' do
        @purchase_shipping_adress.user_id = @user.id
        @purchase_shipping_adress.item_id = @item.id
        ...
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include("電話番号を入力してください")
      end
      it '電話番号は、10桁以上11桁以内の半角数値のみ保存可能なこと（良い例：09012345678 良くない例：090-1234-5678）。' do
        ...
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include('電話番号は不正な値です')
      end
      it '電話番号は、10桁以上11桁以内の半角数値のみ保存可能なこと（良い例：09012345678 良くない例：12345678）。' do
        @purchase_shipping_adress.user_id = @user.id
        @purchase_shipping_adress.item_id = @item.id
        @purchase_shipping_adress.phone_number = '12345678'
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include('電話番号は不正な値です')
      end
      it '電話番号は、10桁以上11桁以内の半角数値のみ保存可能なこと（良い例：09012345678 良くない例：123456789012）。' do
        @purchase_shipping_adress.user_id = @user.id
        @purchase_shipping_adress.item_id = @item.id
        @purchase_shipping_adress.phone_number = '123456789012'
        @purchase_shipping_adress.valid?
        expect(@purchase_shipping_adress.errors.full_messages).to include('電話番号は不正な値です')
      end
